...
\section{Controlador PID}
	...
	O termo proporcional tem o objetivo de minimizar o erro ($e$) do sistema, que é a diferença entre o sinal de controle, ou \emph{set point}, ($u_c$) e a variável controlada ($y$)
